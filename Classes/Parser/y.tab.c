...
static const yytype_uint8 yyprhs[] =
{
      ...
      28,    32,    34,    38,    42,    44,    48,    50,    52
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      15,     0,    -1,    15,    16,     5,    -1,    16,     5,    -1,
      17,    -1,    17,     6,    17,    -1,     7,    18,    -1,     8,
      18,    -1,    18,    -1,    17,     7,    18,    -1,    17,     8,
      18,    -1,    19,    -1,    18,     9,    19,    -1,    18,    10,
      19,    -1,    20,    -1,    19,    11,    20,    -1,     3,    -1,
       4,    -1,    12,    17,    13,    -1
};
...
{
       0,    86,    86,    88,    90,    91,    93,    94,    95,    96,
      97,    99,   100,   101,   103,   104,   106,   107,   108
};
#endif
...
{
  "$end", "error", "$undefined", "number", "variable", "';'", "'='",
  "'+'", "'-'", "'*'", "'/'", "'^'", "'('", "')'", "$accept", "input",
  "equ", "exp", "term", "power", "factor", 0
};
#endif
...
{
       0,   256,   257,   258,   259,    59,    61,    43,    45,    42,
      47,    94,    40,    41
};
# endif
...
{
       0,    16,    17,     0,     0,     0,     0,     0,     4,     8,
      11,    14,     6,     7,     0,     1,     0,     3,     0,     0,
       0,     0,     0,     0,    18,     2,     5,     9,    10,    12,
      13,    15
};
...
{
      16,   -10,   -10,     9,     9,    16,     3,    -1,    19,    20,
      -9,   -10,    20,    20,     1,   -10,    17,   -10,    16,     9,
       9,     9,     9,     9,   -10,   -10,    24,    20,    20,    -9,
      -9,   -10
};
...
{
      12,    13,    23,    15,    17,    14,     1,     2,    19,    20,
       3,     4,     1,     2,    24,     5,    27,    28,    26,     1,
       2,     5,    25,     3,     4,    18,    19,    20,     5,    21,
      22,    19,    20,    29,    30,    16,    31
};

static const yytype_uint8 yycheck[] =
{
       3,     4,    11,     0,     5,     5,     3,     4,     7,     8,
       7,     8,     3,     4,    13,    12,    19,    20,    18,     3,
       4,    12,     5,     7,     8,     6,     7,     8,    12,     9,
      10,     7,     8,    21,    22,     6,    23
};
...
{
       0,     3,     4,     7,     8,    12,    15,    16,    17,    18,
      19,    20,    18,    18,    17,     0,    16,     5,     6,     7,
       8,     9,    10,    11,    13,     5,    17,    18,    18,    19,
      19,    20
};
...
//    {printtree ((yyvsp[(2) - (3)].a_tree), 1);}
	{extern void setTree(tree *t); setTree((yyvsp[(2) - (3)].a_tree));}
    break;

  case 3:
#line 88 "parseTree.y"
//    {printtree ((yyvsp[(1) - (2)].a_tree), 1);}
	{extern void setTree(tree *t); setTree((yyvsp[(1) - (2)].a_tree));}
    break;
...
#line 99 "parseTree.y"
  ...
  case 12:
#line 100 "parseTree.y"
    {(yyval.a_tree) = make_operator ((yyvsp[(1) - (3)].a_tree), '*', (yyvsp[(3) - (3)].a_tree));}
    break;

  case 13:
#line 101 "parseTree.y"
    {(yyval.a_tree) = make_operator ((yyvsp[(1) - (3)].a_tree), '/', (yyvsp[(3) - (3)].a_tree));}
    break;

  case 14:
#line 103 "parseTree.y"
    {(yyval.a_tree) = (yyvsp[(1) - (1)].a_tree);}
    break;

  case 15:
#line 104 "parseTree.y"
    {(yyval.a_tree) = make_operator ((yyvsp[(1) - (3)].a_tree), '^', (yyvsp[(3) - (3)].a_tree));}
    break;

  case 16:
#line 106 "parseTree.y"
    {(yyval.a_tree) = make_number ((yyvsp[(1) - (1)].a_number));}
    break;

  case 17:
#line 107 "parseTree.y"
    {(yyval.a_tree) = make_variable ((yyvsp[(1) - (1)].a_variable));}
    break;

  case 18:
#line 108 "parseTree.y"
